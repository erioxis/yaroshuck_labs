...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({title: "Инкремент", theme: theme_data.ThemeData.new({colorSchemeSeed: colors.Colors.indigo}), home: C[1] || CT.C1});
    }
  };
  ...
  main._MyHomePageState = class _MyHomePageState extends framework.State$(main.MyHomePage) {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new(this.widget.title)}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([C[2] || CT.C2, new text.Text.new(dart.str(this[_counter]), {style: theme.Theme.of(context).textTheme.headlineMedium}), new basic.Row.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([new elevated_button.ElevatedButton.new({onPressed: dart.bind(this, _decrementCounter), style: elevated_button.ElevatedButton.styleFrom({backgroundColor: colors.Colors.red, foregroundColor: colors.Colors.black}), child: C[3] || CT.C3}), C[4] || CT.C4, new elevated_button.ElevatedButton.new({onPressed: dart.bind(this, _incrementCounter), style: elevated_button.ElevatedButton.styleFrom({backgroundColor: colors.Colors.green, foregroundColor: colors.Colors.black}), child: C[5] || CT.C5})])}), C[6] || CT.C6, new text_button.TextButton.new({onPressed: dart.bind(this, _resetCounter), style: text_button.TextButton.styleFrom({backgroundColor: colors.Colors.transparent}), child: new text.Text.new("Сбросить", {style: new text_style.TextStyle.new({color: colors.Colors.grey})})})])})})});
    }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;UC7C4B;AACxB,YAAO,iCACE,oBACA,2CACmB;IAI9B;;;QAXmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;;IAiBX;;;;;;;;;;;;AAGsB;IAAkB;;;QAL7B;QAAmB;;AAArC,mDAAkB,GAAG;;EAAuB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAc9C,MAFF,cAAS;AACG,QAAV,iBAAA,AAAQ,iBAAA;;IAEZ;;AAKI,MAFF,cAAS;AACG,QAAV,iBAAA,AAAQ,iBAAA;;IAEZ;;AAKI,MAFF,cAAS;AACK,QAAZ,iBAAW;;IAEf;UAG0B;AACxB,YAAO,oCACG,+BACC,kBAAK,AAAO,4BAEf,6BACG,yCACgC,yCACnB,uCAIhB,kBACa,SAAT,yBACW,AAAY,AAAU,eAAnB,OAAO,8BAEzB,sCACuC,yCAC3B,wBACR,6DACa,iCACW,2DACE,oCACA,8DAK1B,6DACa,iCACW,2DACI,sCACA,kEAOhC,qDACa,6BACO,mDACQ,oCAEnB,kBACL,oBACO,qCAAwB;IAO7C;;;;;;IA1EI,iBAAW;;;EA2EjB;;;;;;;;;;;;;;;;AAvGuB,IAArB;EACF;;ECGwB","file":"main.js"}');
  // Exports:
  return {
